    ...
    return (
        <SafeAreaView style= {styles.container}>
            ...
            <View style = {styles.ImgBtnView}>
                    ...
                    <TouchableOpacity style = {styles.TouchableOpacity} onPress = {goToPayments}>
            ...
            <View style = {styles.PaginationView}>
                <View >
                <Text style = {styles.Previous} onPress = {goBack}>Previous</Text>
                </View>
                ...
                <View>
                <Text style= {styles.Next} onPress = {goToPayments}>Next</Text>
                </View>
